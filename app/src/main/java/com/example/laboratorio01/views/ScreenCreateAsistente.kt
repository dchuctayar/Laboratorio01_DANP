...
@Composable
fun ScreenCreateAsistente(navController: NavHostController, listaAsistentes:MutableList<Asistente>)
{

    val nombre = remember { mutableStateOf("") }
    val apellido = remember { mutableStateOf("") }
    val fechaInscripcion = remember { mutableStateOf("") }
    val tipoSangre = remember { mutableStateOf("") }
    val telefono = remember { mutableStateOf("") }
    val correo = remember { mutableStateOf("") }
    val montoPagado = remember { mutableStateOf("") }
